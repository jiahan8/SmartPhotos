...
package com.jiahan.smartcamera.textdetector
...
import com.jiahan.smartcamera.GraphicOverlay.Graphic
...
class TextGraphic constructor(overlay: GraphicOverlay?, private val text: Text) :
  ...
  override fun draw(canvas: Canvas) {
    ...
    StillImageActivity.bottomSheetText = text.text
  ...
  companion object {
    ...
    private const val TEXT_SIZE = 38.0f
