...
public class CameraSource {
  ...
  public synchronized com.jiahan.smartcamera.CameraSource start() throws IOException {
    if (camera != null) {
      return this;
    }
   ...
   */
  @RequiresPermission(Manifest.permission.CAMERA)
  public synchronized com.jiahan.smartcamera.CameraSource start(SurfaceHolder surfaceHolder) throws IOException {
    if (camera != null) {
      return this;
    }
