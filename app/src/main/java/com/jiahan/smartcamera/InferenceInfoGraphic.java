...
//    canvas.drawText("InputImage size: " + overlay.getImageWidth() + "x" + overlay.getImageHeight(), x, y, textPaint);

    // Draw FPS (if valid) and inference latency
    if (framesPerSecond != null) {
//      canvas.drawText("FPS: " + framesPerSecond + ", Frame latency: " + frameLatency + " ms", x, y + TEXT_SIZE, textPaint);
