...
include(":core:domain-testing")
include(":core:screenshot-testing")
include(":core:ui-testing")
include(":feature:auth")
include(":feature:auth-viewmodel")
include(":feature:explore")
include(":feature:explore-viewmodel")
include(":feature:favorite")
include(":feature:favorite-viewmodel")
include(":feature:home")
include(":feature:home-viewmodel")
include(":feature:note")
include(":feature:note-viewmodel")
include(":feature:preview")
include(":feature:preview-viewmodel")
include(":feature:profile")
include(":feature:profile-viewmodel")
include(":feature:search")
include(":feature:search-viewmodel")
