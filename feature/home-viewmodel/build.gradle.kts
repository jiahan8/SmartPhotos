/*
 * Kotlin Multiplatform half of :feature:home: HomeViewModel and its suite.
 *
 * Moved together with Search and Favorite, once the note delegates all three inject had gone to
